...
try {
    ...
    $session = $paymentHandler->orderSession([
        ...
        "action" => "paymentPage",
        "return_url" => "https://vshhospital.com/static/payments/handlePaymentResponseCheckupHeart.php?appointment_id=$appointmentId&amount=$amount"  // HDFC will redirect to this URL after payment
    ]);
