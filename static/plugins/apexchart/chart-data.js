...
$(document).ready(function () {
    ...
    if ($("#transaction-wallet").length > 0) {
        var sCol = {
            ...
            series: [
                { name: "Deposit", color: "#0DBF0A", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
                { name: "Withdraw", color: "#FE3F51", data: [76, 85, 101, 98, 87, 105, 91, 114, 94] },
            ],
        ...
        var chart = new ApexCharts(document.querySelector("#transaction-wallet"), sCol);
        chart.render();
    }
    if ($("#sales_chart").length > 0) {
        var columnCtx = document.getElementById("sales_chart"),
            columnConfig = {
                ...
                chart: { type: "bar", fontFamily: "DM Sans, sans-serif", height: 350, toolbar: { show: false } },
    ...
    if ($("#invoice_chart").length > 0) {
        var pieCtx = document.getElementById("invoice_chart"),
            pieConfig = {
                ...
                series: [55, 40, 20, 10],
                chart: { fontFamily: "DM Sans, sans-serif", height: 350, type: "donut" },
    ...
    if ($("#l-col").length > 0) {
        var sCol = {
            ...
            series: [{ color: "#0DBF0A", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] }],
            fill: { opacity: 1 },
            tooltip: {
                y: {
                    formatter: function (val) {
    ...
    if ($("#temperature-chart").length > 0) {
        var sColStacked = {
            ...
            series: [
                { name: "Low", color: "#D5D7ED", data: [10, 30, 10, 30, 10, 30, 30] },
                { name: "High", color: "#2E37A4", data: [20, 20, 20, 20, 20, 20, 20] },
            ],
            xaxis: { categories: ["1", "10", "20", "30", "40", "50", "60"] },
        };
        var chart = new ApexCharts(document.querySelector("#temperature-chart"), sColStacked);
        chart.render();
    }
    if ($("#pressure-chart").length > 0) {
        var sCol = {
            chart: { height: 220, type: "bar", stacked: true, toolbar: { show: false } },
            plotOptions: { bar: { horizontal: false, columnWidth: "30%", endingShape: "rounded" } },
            dataLabels: { enabled: false },
            stroke: { show: true, width: 1 },
            series: [
                { name: "High", color: "#2E37A4", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
                { name: "Low", color: "rgba(46, 55, 164, 0.05)", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
            ],
            tooltip: {
                y: {
                    formatter: function (val) {
    ...
    if ($("#activity-chart").length > 0) {
        var sColStacked = {
            ...
            stroke: { show: true, width: 6, colors: ["transparent"] },
            series: [
                { name: "Low", color: "#D5D7ED", data: [20, 30, 41, 67, 22, 43, 40, 10, 30, 20, 40] },
                { name: "High", color: "#2E37A4", data: [13, 23, 20, 8, 13, 27, 30, 25, 10, 15, 20] },
            ],
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] },
        };
        var chart = new ApexCharts(document.querySelector("#activity-chart"), sColStacked);
        chart.render();
    }
    ...
    if ($("#apexcharts-area").length > 0) {
        var options = {
            ...
            dataLabels: { enabled: false },
            stroke: { curve: "smooth" },
            series: [{ name: "Income", color: "#2E37A4", data: [45, 60, 75, 51, 42, 42, 30] }],
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"] },
        };
    ...
    if ($("#health-chart").length > 0) {
        var options = {
            ...
            dataLabels: { enabled: false },
            stroke: { curve: "smooth" },
            series: [{ name: "Health", color: "#00D3C7", data: [20, 40, 85, 25, 50, 30, 50, 20, 50, 40, 30, 20] }],
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Nov", "Dec"] },
        };
        var chart = new ApexCharts(document.querySelector("#health-chart"), options);
        chart.render();
    }
    if ($("#heart-rate").length > 0) {
        var options = {
            ...
            dataLabels: { enabled: false },
            stroke: { curve: "smooth" },
            series: [{ name: "Health", color: "#FF3667", data: [20, 20, 85, 35, 60, 30, 20] }],
    ...
    if ($("#sleep-chart").length > 0) {
        var options = {
            ...
            dataLabels: { enabled: false },
            stroke: { curve: "smooth" },
            series: [{ name: "Sleep", color: "#2E37A4", data: [20, 21, 20, 21, 20, 21, 22] }],
            xaxis: { categories: ["0", "1", "2", "3", "4", "5", "6"] },
        };
    ...
    if ($("#radial-patients").length > 0) {
        ...
        var donut = new ApexCharts(document.querySelector("#radial-patients"), donutChart);
        donut.render();
    }
    if ($("#s-bar").length > 0) {
        var sBar = {
